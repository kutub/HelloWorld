<x-app-layout>
    ...
    <div class="w-full h-full" style="background-image: url('../images/1.png'); background-repeat: no-repeat;background-position: center; background-size: 800px 1080px">
        <div class="flex flex-row justify-center">
            <div class="basis-2/4 bg-white py-16">
                <form method="POST" action="{{ route('tenants.store') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="domain_name" class="block mt-1 w-full" type="text" name="domain_name" :value="old('domain_name')" required autofocus autocomplete="domain" />
